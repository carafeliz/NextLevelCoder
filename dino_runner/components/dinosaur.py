...
import pygame
from dino_runner.utils.constants import DEFAULT_TYPE, DUCKING_SHIELD,RUNNING_SHIELD,JUMPING_SHIELD, JUMPING, RUNNING, DUCKING, SHIELD_TYPE
from pygame.sprite import Sprite

class Dinosaur(Sprite): # heredando atributos de otra clase
    X_POS = 80
    Y_POS = 310
    Y_POS_DUCK = 360
    JUMP_VEL = 8.5
    ...
    def jump (self):
        ...
        if self.jump_vel < -self.JUMP_VEL:
            self.dino_rect.y = self.Y_POS
            self.dino_jump = False
            self.jump_vel = self.JUMP_VEL # reseteo
